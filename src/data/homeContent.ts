...
export const homeContent = {
  hero: {
    ...
    subtitle: 'רפואת נשים ופוריות בהתאמה אישית לאורך כל שלבי החיים',
  ...
  about: {
    ...
    paragraphs: [
      'ד״ר מרים ספראי היא רופאת נשים מומחית בתחום הפריון, שימור פוריות, IVF, טיפולי ART ומניל המעבר. תחום ייחודי בעבודתה הוא ליווי גינקולוגי ופוריותי של נשים עם רקע אונקולוגי — משלב האבחנה ושימור הפוריות, דרך מעבר גינקולוגי בתקופת הטיפולים, ועד מעקב לאחור החלמה וכניון הריון.',
      'בנוסף, ד״ר ספראי מבצעת מעקבים במצבים ייחודיים, כגון רזרבה שחלתית נמוכה, תסמונת טרנר, נשאות X שביר ומעבר מוקדם. לצד עבודתה הקלינית, היא עוסקת במחקר בתחום הפריון ושימור הפוריות, מרצה בכנסים ומדריכה סטודנטים ומתמחים.',
    ],
    imageAlt: 'אודות',
    timeline: [
      {
